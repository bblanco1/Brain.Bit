...
struct  CloudRecoAbstractBehaviour_t44  : public MonoBehaviour_t2
{
	// Vuforia.ObjectTracker Vuforia.CloudRecoAbstractBehaviour::mObjectTracker
	ObjectTracker_t762 * ___mObjectTracker_2;
