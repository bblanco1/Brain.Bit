...
struct  MonoCameraConfiguration_t747  : public Object_t
{
	// UnityEngine.Camera Vuforia.MonoCameraConfiguration::mPrimaryCamera
	Camera_t114 * ___mPrimaryCamera_0;
	...
	Action_t141 * ___mOnVideoBackgroundConfigChanged_3;
	...
	Dictionary_2_t748 * ___mVideoBackgroundBehaviours_4;
	// UnityEngine.Rect Vuforia.MonoCameraConfiguration::mViewportRect
	Rect_t116  ___mViewportRect_5;
