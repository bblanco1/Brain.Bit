...
struct  X509Store_t1368  : public Object_t
{
	...
	X509Certificate2Collection_t1362 * ___list_2;
	...
	X509Store_t1171 * ___store_4;
};
struct X509Store_t1368_StaticFields{
	...
	Dictionary_2_t311 * ___U3CU3Ef__switchU24mapF_5;
};
