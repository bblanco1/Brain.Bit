...
struct KeepAliveAbstractBehaviour_t66;
...
// Vuforia.KeepAliveAbstractBehaviour
struct  KeepAliveAbstractBehaviour_t66  : public MonoBehaviour_t2
{
	...
	List_1_t895 * ___mHandlers_9;
};
struct KeepAliveAbstractBehaviour_t66_StaticFields{
	// Vuforia.KeepAliveAbstractBehaviour Vuforia.KeepAliveAbstractBehaviour::sKeepAliveBehaviour
	KeepAliveAbstractBehaviour_t66 * ___sKeepAliveBehaviour_8;
};
